...
| Web real (`apps/web`) | Next.js con Clerk (Google), `/sign-in` `/sign-up`, `GET /api/sia/me` hacia la API, `/api/health`. | Expediente y seguimiento aún no conectados; OAuth/staging sin verificar. |
